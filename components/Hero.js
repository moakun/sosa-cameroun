      ...
      <ScrollAnimationWrapper>
          <motion.div
            ...
            <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
              ...
              <p className="text-sm text-black mt-4">
              Après avoir reçu votre certificat, veuillez l&apos;envoyer à l&apos;adresse e-mail suivante: <a href="mailto:fadimatou.ndjento-peboura@vinci-construction.com" className="text-blue-500 underline">fadimatou.ndjento-peboura@vinci-construction.com</a>
              </p>
            </div>
